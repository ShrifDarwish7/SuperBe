...
class ChatVC: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // pusher dev key: 123d1a18cea91eab7b90
        ...
        //NotificationCenter.default.addObserver(self, selector: #selector(appDidEnterForeground(_:)), name: UIApplication.willEnterForegroundNotification, object: nil)
        ...
        Shared.isChatting = true // this for skip waiting for agent step :(
        ...
        if Shared.isChatting{
            ...
            if Shared.orderChatting!{
                presenter?.getOrderConversation(Shared.orderChattingId!)
            }else{
                presenter?.getSupportMessages()
            }
...
//        progressView.startAnimating()
    ...
    @IBAction func sendMessageAction(_ sender: Any) {
        ...
        guard !messageTV.text!.isEmpty else { return }
...
//        alert.addAction(UIAlertAction(title: "Exit".localized, style: .destructive, handler: { (_) in
